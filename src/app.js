...
// the json data we will recieve should have limit
app.use(express.json({limit: "16kb"}))


// to make server understand encoded url 
...
// we wanna store some file on server so we make
// public folder (public assets)
app.use(express.static("public"))


// CRUD on cookies from user browser
